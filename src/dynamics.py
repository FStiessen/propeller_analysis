...
class dynamics:
    ...
    def balance_blade(self):
        ...
        self.tension = -cumulative_trapezoid(f[::-1], self.r[::-1],
                                             initial=0)[::-1]
        self.normal_stress = self.tension/self.areas
        self.shear_n = -cumulative_trapezoid(self.p_n[::-1], self.r[::-1],
                                             initial=0)[::-1]
        self.shear_t = -cumulative_trapezoid(self.p_t[::-1], self.r[::-1],
                                             initial=0)[::-1]
